...
const sections = [
  {
    ...
    description:
      "Monitor your daily activity, set fitness goals, and visualize your progress with WellnessHub's comprehensive fitness tracking. Stay motivated with detailed insights into your workouts, step counts, calories burned, and more, helping you achieve a healthier lifestyle.",
    image: image1,
