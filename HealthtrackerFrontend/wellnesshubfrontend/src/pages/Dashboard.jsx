...
export default function Dashboard() {
  ...
  /* ✅ for refreshing medication list */
  const [reloadMedications, setReloadMedications] = useState(false);
  ...
  /* refresh medication table after adding */
  const refreshMedications = () => {
    setReloadMedications(!reloadMedications);
  };
          ...
          <div className="flex-1 space-y-8 mt-8 md:mt-0">
            ...
            {loading ? (
              ...
              <>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                  <DoughnutChart /> 
                   <MedicationList reload={reloadMedications} />
                </div>
